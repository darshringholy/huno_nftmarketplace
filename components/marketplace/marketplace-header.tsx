...
import { Search, Bell, ChevronDown, Menu, X, Wallet, User } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <DropdownMenu>
              ...
              <DropdownMenuContent className="bg-gray-900 border-gray-700 text-white">
                ...
                <DropdownMenuItem className="hover:bg-gray-800 focus:bg-gray-800">
                  <Link href="/marketplace/collections/verify" className="w-full">
          ...
          <div className="hidden md:flex items-center space-x-4">
            {/* UK Flag */}
            <img src="/images/uk-flag.svg" alt="Plume" className="w-8 h-8" draggable={false} />
            ...
            {/* User Profile - Clickable with Dynamic Network Icon */}
            <button
            ...
            <div className="space-y-4 pt-4">
              ...
              <nav className="space-y-2">
                <div className="space-y-1">
                  ...
                  <Link
                    href="/marketplace/collections/verify"
                    className="block py-2 px-6 text-gray-300 hover:text-white hover:bg-gray-800 rounded transition-colors"
                  >
                    Collection Verification
                  </Link>
                ...
                <button onClick={() => setNetworkDialogOpen(true)} className="flex items-center space-x-3">
                  ...
                  {currentNetwork === "ethereum" && (
                    <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center">
                      <div
                        className="w-4 h-5 bg-white"
                        style={{ clipPath: "polygon(50% 0%, 0% 40%, 50% 60%, 100% 40%)" }}
                      ></div>
                    </div>
                  )}
                  {currentNetwork === "polygon" && (
